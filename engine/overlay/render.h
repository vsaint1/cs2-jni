...
bool load_image_from_memory(void *data, size_t size, IDirect3DTexture9 **out_texture) {
  ...
  D3DXIMAGE_INFO info;
  HRESULT hr =
      D3DXCreateTextureFromFileInMemoryEx(p_Device, data, size, D3DX_DEFAULT, D3DX_DEFAULT, 1, NULL, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_FILTER_NONE, D3DX_FILTER_NONE, NULL, &info, NULL, &texture);
