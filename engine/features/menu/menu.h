...
void draw_menu() {
  ...
  ImGui::Begin(("JNI - Engine"), &settings::bMenu, ImGuiWindowFlags_::ImGuiWindowFlags_NoResize | ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse);
  ...
  if (ImGui::BeginTabItem("Misc")) {
    ...
    if (ImGui::Button("Github"))
      ShellExecuteA(NULL, "open", "https://github.com/vsaint1/cheetos-engine", NULL, NULL, SW_SHOWNORMAL);
